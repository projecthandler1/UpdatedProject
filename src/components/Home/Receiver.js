...
function Receiver() {
  return (
    <>
      ...
      <h1 className="text-center font-bold p-[15px] bg-black text-white">LIST OF AVAILABLE USE</h1>
      <ul className="sm:px-[200px] md:px-[650px] mt-[30px] ">
        <li class="text-body-color mb-4 flex text-base">
          <span class="text-secondary mr-2 rounded-full text-base">
            <svg
              width="20"
              height="20"
              viewBox="0 0 20 20"
